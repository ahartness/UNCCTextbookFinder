...
<?php
		...
		$results = mysqli_query($db, "SELECT * FROM book WHERE Title LIKE '%".$query."%' OR ISBN LIKE '%".$query."%' ORDER BY Price ASC") or die(mysql_error());
		...
		while($row = mysqli_fetch_array($results)){
			$price = number_format($row['Price'],2);
				...
				echo				"<img src='images/books/".$row['Title'].".jpg'/>";
				echo		"</div>";
